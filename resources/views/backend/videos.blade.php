...
<div class="content">
    <div class="breadcrumb-wrapper breadcrumb-contacts">
        <div>
            ...
            <p class="breadcrumbs"><span><a href="{{ route('dashboard') }}">Dashboard</a></span>
                <span><i class="mdi mdi-chevron-right"></i></span>Video
            </p>
        </div>
        <div>
            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                data-bs-target="#addvideo"> Add Video
            </button>
        </div>
    </div>
                            ...
                            <tbody>
                                @foreach ($videos as $video)
                                    <tr>
                                        <td>
                                            @if($video->image != null) 
                                                <img width="100" src="{{ asset('uploads/videos') }}/{{ $video->image }}" alt="Image" />
                                            @endif
                                        </td>
                                        <td>
                                            @if ($video->title != null)
                                        ...
                                        <td>
                                            <div class="btn-group mb-1">
                                                ...
                                                <div class="dropdown-menu">
                                                    <button type="button" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#editvideo{{ $video->id }}">
                                                        Edit
                                                    </button>
                                    ...
                                    <div class="modal fade modal-add-contact" id="editvideo{{ $video->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                            ...
                                            <div class="modal-content">
                                                <form action="{{ route('videos.update', $video->id) }}" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="modal-header px-4">
                                                        <h5 class="modal-title" id="exampleModalCenterTitle">Edit video</h5>
                                                    </div>
                                                    ...
                                                    <div class="modal-body px-4">
                                                        <div class="form-group row mb-6">
                                                            ...
                                                            <div class="col-sm-4 col-lg-4" style="height: 100px">
                                                                <img width="100" id="blah" src="{{ asset('uploads/video') }}/{{ $video->image }}" alt="">
                                                            </div>
                                                        </div>
                                                        <div class="row mb-2">
                                                            <div class="col-lg-12">
                                                                <div class="form-group mb-4">
                                                                    ...
                                                                    <input type="text" id="videolink" class="form-control @error('videolink') is-invalid @enderror" name="videolink" value="{{ $video->videolink }}">
                                                                    @error('videolink')
                                                                        <span class="text-danger">{{$message}}</span>
                                                                    @enderror
                                                                </div>
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="form-group mb-4">
                                                                    ...
                                                                    <input type="text" id="title" class="form-control @error('title') is-invalid @enderror" name="title" value="{{ $video->title }}">
                                                                    @error('title')
                                                                        <span class="text-danger">{{$message}}</span>
                                                                    @enderror
                                                                </div>
    ...
    <!-- Add video Modal  -->
    <div class="modal fade modal-add-contact" id="addvideo" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <form action="{{ route('videos.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-header px-4">
                        <h5 class="modal-title" id="exampleModalCenterTitle">Add New video</h5>
                    </div>
                    ...
                    <div class="modal-body px-4">
                        ...
                        <div class="row mb-2">
                            <div class="col-lg-12">
                                <div class="form-group mb-4">
                                    <label for="videolink">Video Link <span class="text-danger">*</span></label>
                                    <input type="text" id="videolink" class="form-control @error('videolink') is-invalid @enderror" name="videolink" value="{{ old('videolink') }}">
                                    @error('videolink')
                                        <span class="text-danger">{{$message}}</span>
                                    @enderror
                                </div>
